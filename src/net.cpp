...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pacificcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pacificcointools.com", "dnsseed.pacificcointools.com"},
    {"pacificcoinpool.org", "dnsseed.pacificcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"pacificcointools.com", "testnet-seed.pacificcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pacificcoin is probably already running."), addrBind.ToString().c_str());
        else
